...
bool D3DClass::initialize(int screenHeight, int screenWidth, HWND hwnd, bool vsync, bool fullScreen)
{
	...
	// Set the feature level to DirectX 12.1
	featureLevel = D3D_FEATURE_LEVEL_12_1;

	// Generate the Direct3D Device
	...
	// Set up the command queue's description
	...
	// Enumerate the adapter output to the monitor
	...
	////// LOADASSETS FROM TUTORIAL STARTS HERE ///////
...
std::wstring D3DClass::getAssetFullPath(LPCWSTR assetName)
{
	WCHAR assetsPath[512];
	GetAssetsPath(assetsPath, _countof(assetsPath));
	std::wstring stringAssetsPath = assetsPath;
	return stringAssetsPath + assetName;
}
